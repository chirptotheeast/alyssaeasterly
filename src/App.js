...
function App() {
  ...
  return (
    <div>
      ...
      <footer id="footer" className="bg-yellow-100 footer">
        <div className="layout ">
          <div className="flex flex-row it">
            {/* <div className="flex "> */}
            <a
              className="link"
              href="https://github.com/chirptotheeast"
              target="_blank"
            ...
            <a
              ...
              href="https://alyssa-e-easterly.medium.com/"
              target="_blank"
              data-tippy-content="github-link"
            >
              <svg
                className="m-6 text-gray-600 fill-current h-11 hover:text-blue-200"
                role="img"
            ...
            <a
              className="link"
              href="https://www.linkedin.com/in/alyssa-easterly/"
              target="_blank"
