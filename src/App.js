      ...
      <nav className="sticky top-0 bg-white">
        <div className="flex items-center justify-between py-2 text-black layout">
          ...
          <ul className="flex items-center justify-between space-x-8">
            ...
            <li>
              <a
                className="mr-16 underline hover:text-gray-700"
                target="_blank"
            ...
            <div className="items-center md:flex">
              <div className="w-full md:w-1/2">
                <div className="max-w-lg">
                  <div className="flex flex-wrap items-center justify-between pb-16 mx-auto mt-6 lg:pb-0 lg:w-full">
                    <img
                    ...
                    >
                      <svg
                        className="mb-8 text-gray-600 fill-current h-11 hover:text-blue-200"
                        role="img"
                        viewBox="0 0 24 24"
                    ...
                    >
                      <svg
                        className="text-gray-600 fill-current h-11 hover:text-blue-200"
                        role="img"
                        viewBox="0 0 24 24"
                        xmlns="http://www.w3.org/2000/svg"
                      >
