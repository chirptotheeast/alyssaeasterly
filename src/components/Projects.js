...
import gardenproj from '../images/garden-bg.png'
                ...
                <div className="flex flex-wrap items-center h-auto max-w-4xl mx-auto my-12 lg:h-screen lg:my-12">
                  ...
                  >
                    <div className="p-4 text-center md:p-12 lg:text-left">
                      ...
                      <p className="pt-8 text-sm">Family Entertainment App</p>

                      <div className="pt-12 pb-8">
                        <button className="px-4 py-2 font-bold text-white bg-green-700 rounded-full hover:bg-green-600 focus:outline-none">
                          <a
                            href="https://youtu.be/LmqgqUvxUUY"
                            target="_blank"
                          >
                            Demo
                          </a>
                  ...
                  >
                    <div className="p-4 text-center md:p-12 lg:text-left">
                      ...
                      <div className="pt-12 pb-8">
                        <button className="px-4 py-2 font-bold text-white bg-green-700 rounded-full hover:bg-green-600 focus:outline-none">
                          <a
                            href="https://youtu.be/ap0iPhLYMZQ"
                            target="_blank"
                          >
                            Demo
                          </a>
                  ...
                  >
                    <div className="p-4 text-center md:p-12 lg:text-left">
                      ...
                      <p className="flex items-center justify-center pt-4 text-base font-bold lg:justify-start">
                        ...
                        React, Next.js, Firebase.db, Javascript, Tailwind.css
                      </p>
                  ...
                  >
                    <div className="p-4 text-center md:p-12 lg:text-left">
                      ...
                      <p className="flex items-center justify-center pt-4 text-base font-bold lg:justify-start">
                        ...
                        React, Next.js, Ruby on Rails, PostgreSQL, Firebase
                        Auth, Javascript
                      </p>
                      <p className="pt-8 text-sm">
                        Journaling app to cultivate nurturing differences.
                      </p>

                      <div className="pt-12 pb-8">
                        <button className="px-4 py-2 font-bold text-white bg-green-700 rounded-full hover:bg-green-600 focus:outline-none">
                          <a
                            href="https://the-nurturing-garden.vercel.app/"
                            target="_blank"
                          >
                            Live Site
                          </a>
